...
module OryKratosClient
  ...
  class AuthenticateOKBody
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'identity_token')
        self.identity_token = attributes[:'identity_token']
      end
    ...
    def list_invalid_properties
      ...
      if @identity_token.nil?
        invalid_properties.push('invalid value for "identity_token", identity_token cannot be nil.')
      end
    ...
    def valid?
      return false if @identity_token.nil?
